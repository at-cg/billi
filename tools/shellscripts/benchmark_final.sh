...
#PBS -o benchmark_final.log
#PBS -e benchmark_final.err
...
SHELL_EXE4=tool_scripts/povu.sh

chmod +x $SHELL_EXE1 $SHELL_EXE2 $SHELL_EXE3 $SHELL_EXE4
...
#     sh $SHELL_EXE4 ${DATA[$i]} $OUT_DIR ${TAG[$i]} $LOG
