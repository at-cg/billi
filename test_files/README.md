...
This folder contains test graphs in GFA format to empirically validate the correctness of Billi's `decompose` and `compact` subcommands. Each subfolder covers a different category of graph structure and every subfolder includes a PDF file with the visualisations of the graphs it contains.
